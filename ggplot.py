...
class ggplot(Scene):
    def construct(self):
        ...
        subject_label = Text("Subject", font_size=12, font="Iosevka Term").next_to(underline_1, DOWN)
        verb_label = Text("Verb", font_size=12, font="Iosevka Term").next_to(underline_2, DOWN)
        object_label = Text("Object", font_size=12, font="Iosevka Term").next_to(underline_3, DOWN)
        preposition_label = Text("Preposition", font_size=12, font="Iosevka Term").next_to(underline_4, DOWN)
        location_label = Text("Location", font_size=12, font="Iosevka Term").next_to(underline_5, UP* 2.1)
        noun_label = Text("Noun", font_size=12, font="Iosevka Term").next_to(underline_6, DOWN)
